#!/bin/bash
#SBATCH -J 02C_opt_hidstate     # Job name
...
# run code
cd /n/home05/fmottes/Projects/jax-morph/Francesco/ALIFE_plots/02-Vshape/C_opt_hidstate_size

python 02C_opt_hidstate.py