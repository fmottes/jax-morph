...
def run_experiment():
    ...
    n_cells = [49, 74, 99, 124, 149, 199]

    for N_CELLS in n_cells:

        Dparams['ncells_add'] = N_CELLS
        ...
        log.opt_runs[N_CELLS] = LogRep(loss_t=loss_t, params_t=params_t, grads_t=None)


    with open('02Blog_opt_ncells.pkl', 'wb') as f:
        pickle.dump(log, f)
